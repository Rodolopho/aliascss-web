<div class="p32px">
    ...
    <h1 class="m64px0px tdu heading-md">Title and Heading</h1>
    <ul x-data="{ displayClasses: ['heading-2xl','heading-xl','heading-lg','heading-md','heading-sm','heading-xs']}" class="p0px">
        <template x-for="className in displayClasses">
            <div class="" acss-class="heading-2xl heading-xl heading-lg heading-md heading-sm heading-xs">
                <p x-bind:class="className" class=" df aic p0px20px c-gray700 brt2px-s-gray400" >Welcome to AliasCSS <small class=" dib br5px  p2px8px ml8px bgc-blue50 text-xs fw5 c-gray500" x-text="'.' + className+ ' '"></small></p>
            </div>
        </template>
    </ul>
