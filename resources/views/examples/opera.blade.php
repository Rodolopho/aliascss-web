<x-app-layout>
    ...
    <main class="welcome-page welcome-page--r20">
        <div class="header-wrapper">
            <header id="header" class="b1px-s-gray300 ">
                <div class=" df jcsb  fdc md-fdr  p20px lg-p20px93px">
                    <div class="df aic g24px">
                        <a href="#" class=" heading-sm tdn pr32px brt1px-s-gray300" title="Opera">
                            <i class="c-error600 fa-brands fa-opera"></i>
                            <span class="c-gray500 fw2">Opera</span>
                        </a>
                        <p class="df g16px fw5 text-xs">
                            <span class="fw5 fs16px-i"><i class="fa-solid c-success600 fa-circle-check"></i></span>
                            Update complete!
                        </p>
                    </div>
                    <div class="df fdc _p-m0px g8px brt1px-s-gray300 pr12px">
                        <p class="text-sm fw5 c-gray900">Opera is up to date</p>
                        <p class="text-xs md-asfe c-gray400">Latest additions</p>
                    </div>
                </div>
            </header>
        </div>
                ...
                <div class="df aic jcsb p20px g16px">
                    <div class="">
                        <div class="df aic g8px">
                            <h1 class="m0px heading-xs fwn">
                                New AI features
                            </h1>
                            <span class="bgc-success600 c-fff p4px4px text-sm">Early Access</span>
                        </div>
                        <p class="m0px text-sm fw6 c-gray400">Expand your browsing capabilities with contextual AI prompts. Try it
                            now in early access.</p>
                    </div>
                    <div class="bgc-gray200  br50px pr16px  jcsb  dif aic mw100px asfs">
                        <span class="w32px h32px br50p bgc-gray300 dif jcc  aic">
                            <i class=" df fa-solid fa-sliders"></i>
                        </span>
                        <span class="wsn text-xs fw6">SET UP</span>
                    </div>
                </div>
        </div>
    </div>
    <!------End Hero------------>
    <!------Hero------------>
    <div class="lg-p20px93px  p20px sub-hero dg md-gta-name_name  g32px  fww _all-bsbb w100p" x-data>

                <div class=" br16px  oh b1px-s-gray300 ">
                    <div class="w100p h400px bgc-blue100"></div>
                    <div class="df aic jcsb p20px g16px">
                        <div class="">
                            <div class="df aic g8px">
                                <h1 class="m0px heading-xs fwn">
                            ...
                            <p class="m0px text-sm fw6 c-gray400">Enhance online videos and images in one click.</p>
                        </div>
                        <div class="bgc-gray200  br50px pr16px  jcsb  dif aic mw100px asfs">
                            <span class="w32px h32px br50p bgc-gray300 dif jcc  aic">
                                <i class=" df fa-solid fa-sliders"></i>
                            </span>
                            <span class="wsn text-xs fw6">SHOW ME</span>
                        </div>
                    </div>
                </div>
        ...
        <div class=" br16px  oh b1px-s-gray300 ">
            ...
            <div class="df aic jcsb p20px g16px">
                <div class="">
                    ...
                    <p class="m0px text-sm fw6 c-gray400">Beyond our free browser VPN, Opera can now protect your entire device with premium VPN Pro.</p>
                </div>
                <div class="bgc-gray200  br50px pr16px  jcsb  dif aic mw100px asfs">
                    <span class="w32px h32px br50p bgc-gray300 dif jcc  aic">
                        <i class=" df fa-solid fa-sliders"></i>
                    </span>
                    <span class="wsn text-xs fw6">FREE TRIAL</span>
                </div>
            </div>
        </div>
        ...
        <div class=" br16px  oh b1px-s-gray300 ">
            ...
            <div class="df aic jcsb p20px g16px">
                <div class="">
                    ...
                    <p class="m0px text-sm fw6 c-gray400">Save and collect web content easily, share it visually</p>
                </div>
                <div class="bgc-gray200  br50px pr16px  jcsb  dif aic mw100px asfs">
                    <span class="w32px h32px br50p bgc-gray300 dif jcc  aic">
                        <i class=" df fa-solid fa-sliders"></i>
                    </span>
                    <span class="wsn text-xs fw6">SEE MORE</span>
                </div>
            </div>
        </div>
        ...
        <div class=" br16px  oh b1px-s-gray300 ">
            ...
            <div class="df aic jcsb p20px g16px">
                <div class="">
                    ...
                    <p class="m0px text-sm fw6 c-gray400">Keep meetings on top in a separate adjustable window</p>
                </div>
                <div class="bgc-gray200  br50px pr16px  jcsb  dif aic mw100px asfs">
                    <span class="w32px h32px br50p bgc-gray300 dif jcc  aic">
                        <i class=" df fa-solid fa-sliders"></i>
    ...
    <!------End Hero------------>
        ...
        <div class="footer-wrapper">
            ...
            <footer id="footer" class="b1px-s-gray300 ">
                <div class=" df jcsb  fdc md-fdr  p20px lg-p20px93px">
                    <div class="df aic g24px">
                        <a href="#" class=" text-md tdn pr32px" title="Opera">

                            <span class="c-gray700 fw5">© Opera Norway 1995-2023</span>
                        </a>

                    </div>
                    <div class="df fdc _p-m0px g12px pr12px">
                        <div class="df aic g8px">
                            <span class="c-gray900 fw5">Follow Opera</span>
                            <ul class="p0px df lsn g12px ">


                                <li>
                                    <a class="facebook" href="https://www.facebook.com/Opera/" rel="noopener nofollow" target="_blank"
                                ...
                                <li>
                                    <a class="twitter" href="https://twitter.com/opera" rel="noopener nofollow" target="_blank"
                                        title="Opera - Twitter">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M21 6.59819C20.3379 6.86913 19.6257 7.05239 18.8788 7.13423C19.6414 6.71257 20.2267 6.04538 20.5029 5.24908C19.7893 5.63973 18.9986 5.92313 18.1578 6.07588C17.4842 5.41378 16.5244 5 15.4616 5C13.4225 5 11.7687 6.52626 11.7687 8.40811C11.7687 8.67523 11.8014 8.93524 11.8648 9.18483C8.79565 9.04276 6.07436 7.68602 4.25282 5.62347C3.935 6.12672 3.75269 6.71257 3.75269 7.33705C3.75269 8.51918 4.40512 9.56278 5.39548 10.1738C4.79042 10.1563 4.2206 10.003 3.72294 9.74705C3.72267 9.76154 3.72267 9.77602 3.72267 9.79026C3.72267 11.4416 4.99614 12.8189 6.68521 13.1318C6.37565 13.2101 6.04875 13.2515 5.71248 13.2515C5.47397 13.2515 5.24291 13.2304 5.01763 13.1907C5.48747 14.5444 6.85101 15.5298 8.46736 15.5575C7.20325 16.4718 5.61113 17.0164 3.88047 17.0164C3.58303 17.0164 3.28835 17.0004 3 16.9687C4.63343 17.936 6.57505 18.5 8.66042 18.5C15.453 18.5 19.1677 13.3069 19.1677 8.80282C19.1677 8.65515 19.1641 8.50799 19.157 8.3621C19.8791 7.88173 20.5051 7.28164 21 6.59819Z"
                                                fill="black"></path>
                                        </svg>
                                    </a>
                                </li>
                                <li>
                                    <a class="youtube" href="https://www.youtube.com/opera" rel="noopener nofollow" target="_blank"
                                        title="Opera - Youtube">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <a class="linkedin" href="https://www.linkedin.com/company/opera-software" rel="noopener nofollow"
                                        target="_blank" title="Opera - LinkedIn">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <li>
                                    <a class="instagram" href="https://www.instagram.com/opera/" rel="noopener nofollow" target="_blank"
    ...
    <script src="./Opera - Update complete!_files/output.29f359807dff.js"></script>
